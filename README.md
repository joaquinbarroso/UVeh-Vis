## About
UVeh-Vis is a utility designed for plotting UV-Vis spectra from Quantum Chemsitry calculations (Qchem 5.x and Gaussian 16 supported). This tool operates by entry the relevant file(s), specifying the initial and final wavelength, and providing the standard deviation.
